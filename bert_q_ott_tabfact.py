...
#from datasets import load_dataset nao uso no momento, pego arquivo local
...
def get_dataset(max_corpus_size):
    ...
    embedding_cache_path = "/QA/Bert/data/tabfact/{}-size-{}.pkl".format(retriever_model_name.replace("/", "_"), max_corpus_size)
    ...
    if not os.path.exists(embedding_cache_path):
        ...
        if not os.path.exists(dataset_path):
            ...
            exit()
        #read_dataset!!!
        with open("/QA/Bert/data/tabfact/dataset.pkl", "rb") as fIn:
...
if __name__ == '__main__':
    ...
    home = "/nethome/projetos30/busca_semantica/buscaict/BigOil/users/flavio.amorim/QA"
    dataset_path = home + "/Bert/data/tabfact/dataset.pkl"
